...
class Button {
  constructor(x, y, w, l, msg, s) {
    ...
    this.clr1 = color(19, 69, 171); //Color for Buttons#####
    this.clr2 = color(16, 180, 50); //Color for Text#####
  ...
  update() {
    if (this.mouseIsOverButton === false) {
      ...
      this.clr1 = color(19, 69, 171); //Original Button Color#####
      this.clr2 = color(16, 180, 50); //Original Text Color#####
    } else if (this.mouseIsOverButton) {
      //If Mouse is Over a Button#####
      this.clr1 = color(71, 111, 193); //New Button Color#####
      this.clr2 = color(56, 220, 90); //New Text Color#####
    }
  }
